...
def parse_file(input_file):
  ...
  g = open('/home/jason/Kaggle/Facebook/Data/Training/Parsed3/Final/' + output_file, 'w')
  
  # train-file will contain the parsed subset of training for testing
  train_file = input_file.split('.')[0] + '_test.txt'
  t = open('/home/jason/Kaggle/Facebook/Data/Training/Parsed3/Final/' + train_file, 'w')
  ...
  for post in csv_reader:
    ...
    if not any([tag in mid500_tags for tag in tags]):
      continue
