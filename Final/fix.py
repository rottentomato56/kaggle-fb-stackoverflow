...
a_parsed = {}
for file1 in ['test_1_parsed.txt', 'test_2_parsed.txt', 'test_3_parsed.txt']:
  with open('/home/jason/Kaggle/Facebook/Data/Testing/Predictions/' + file1) as f:
    for line in f:
      post_id = int(line.strip().split(',')[0])
      a_parsed[post_id] = 1
...
def run_prediction(test_file):
  ...
  prediction_file = open('/home/jason/Kaggle/Facebook/Data/Testing/Additional/' + test_file, 'w')
  counter = 0
...
if __name__ == '__main__':
  ...
  test_files = ['test_1_parsed.txt', 'test_2_parsed.txt', 'test_3_parsed.txt']
  print test_files
